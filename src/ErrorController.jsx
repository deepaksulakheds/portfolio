      ...
      return (
        <Box
          sx={{
            ...
            justifyContent: "center",
            alignItems: "center",
            bgcolor: themeContext.themeBackground,
            textAlign: "center",
          }}
        >
          ...
          <Typography
            variant="body2"
            sx={{ mb: 4, color: themeContext.oppositeText }}
          >
          ...
          <Button
            ...
            sx={{
              border: `2px solid ${themeContext.themeColor}`,
              color: themeContext.themeColor,
          ...
          {this.state.error && (
            <Box sx={{ mt: 5, maxWidth: 550, textAlign: "left" }}>
              <details
                style={{
                  color: "#555",
                  fontSize: "12px",
                  cursor: "pointer",
                  borderTop: `1px solid ${themeContext.oppositeTheme}`,
                  paddingTop: "10px",
                }}
              >
                <summary
